...
footer.href = "https://www.instagram.com/magx.x.x/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangku Tercinta", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
